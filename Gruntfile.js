...
//           {src: ['bower_components/font-awesome/fonts/**'], dest: 'dist/',filter:'isFile',expand:true}
    ...
    dom_munger:{
      ...
      update: {
        options: {
          ...
          append: [
            {selector:'body',html:'<!--[if lte IE 8]><script src="libcompat-v1.0.13.min.js"></script><![endif]--><!--[if gte IE 9]><script src="libnocompat-v1.0.13.min.js"></script><![endif]--><!--[if !IE]><!--><script src="libnocompat-v1.0.13.min.js"></script><!--<![endif]-->'},
            {selector:'body',html:'<script src="lib-v1.0.13.min.js"></script>'},
            {selector:'body',html:'<script src="avConfig-v1.0.13.js"></script>'},
            {selector:'body',html:'<script src="app-v1.0.13.min.js"></script>'},
            {selector:'head',html:'<link rel="stylesheet" href="app-v1.0.13.full.min.css">'}
          ]
        },
        src:'index.html',
    ...
    cssmin: {
      main: {
        ...
        dest:'dist/app-v1.0.13.full.min.css'
      },
    },
    concat: {
      main: {
        files: {
          ...
          'dist/avConfig-v1.0.13.js': ['avConfig.js']
        }
      }
    },
    ngAnnotate: {
    ...
    uglify: {
      main: {
        ...
        files: {
          'dist/app-v1.0.13.min.js': 'temp/app.js',
          'dist/lib-v1.0.13.min.js': 'temp/lib.js',
          'dist/libnocompat-v1.0.13.min.js': 'temp/libnocompat.js',
          'dist/libcompat-v1.0.13.min.js': 'temp/libcompat.js'
        }
      }
    },
    htmlmin: {
