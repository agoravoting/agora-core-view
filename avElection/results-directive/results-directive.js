  ...
  .directive('avResults', function() {
    ...
    function link(scope, element, attrs) {
      ...
      function initData() {
        ...
        scope.questions = angular.copy(scope.election.questions_data);

        // sort questions by winner position asc or by votes desc
        _.each(scope.questions, function(question) {
          question.answers.sort(function(answer, answer2) {
